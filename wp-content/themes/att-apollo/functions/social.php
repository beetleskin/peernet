		...
		$output = '<ul id="header-social">';
			$att_social_links = att_social_links();
				foreach( $att_social_links as $social_link ) {
					...
					$output .= '<li><a href="'. of_get_option( $social_link ) .'" title="'. $social_link .'" target="_blank"><img src="'. get_template_directory_uri() .'/images/social-alt/'.$social_link.'.png" alt="'. $social_link .'" /></a></li>';
					}
				}
