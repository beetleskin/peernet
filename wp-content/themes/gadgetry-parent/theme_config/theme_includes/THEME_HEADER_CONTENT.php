    ...
    function tfuse_get_slides_from_posts( $posts=array(), $slider = array() )
    {
        ...
        foreach ($posts as $k => $post) : setup_postdata( $post );
            ...
            if ($post->post_type == 'post'){
                    ...
                    $color = array('post_yellow' => 'Yellow', 'post_green' => 'Green','post_purple' => 'Purple','post_red' => 'Red','post_blue' => 'Blue');
                    $position = array('random' => 'Random','left-mid' => 'Left-Middle', 'left-top' => 'Left-Top','left-bot' => 'Left-Bottom','center-mid' => 'Center-Middle','center-top' => 'Center-Top'
