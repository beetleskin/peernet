...
class TFuse_Widget_Adds extends WP_Widget {
    ...
    <!--Ads-->
        ...
        <label><h3><?php _e('Ad 250x250 :', 'tfuse'); ?></h3>
            <textarea class="widefat" rows="4" cols="1"><div class="adv_250"><a href="<?php bloginfo('url'); ?>"><img width="250" height="250" src="wp-content/themes/magazinish-parent/images/adv_250x250.png"></a></div></textarea>
        </label>
        </p>
        <p>
            <label><h3><?php _e('Ad 125x125 :', 'tfuse'); ?></h3>
                <textarea class="widefat" rows="4" cols="1"><div class="adv_125"><a href="<?php bloginfo('url'); ?>"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div></textarea>
            </label>
        </p>
        <p>
            <label><h3><?php _e('4 or more ads 125x125 :', 'tfuse'); ?></h3>
                <textarea class="widefat" rows="4" cols="1">
                    <div class="adv_125_box">
                        <a href="<?php bloginfo('url'); ?>"><div class="adv_125"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div>
                        <a href="<?php bloginfo('url'); ?>"><div class="adv_125"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div>
                        <a href="<?php bloginfo('url'); ?>"><div class="adv_125"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div>
                        <a href="<?php bloginfo('url'); ?>"><div class="adv_125"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div>
                        <div class="clear"></div>
        ...
        <label><h3><?php _e('Ad 160x600 :', 'tfuse'); ?></h3>
            <textarea class="widefat" rows="4" cols="1"><div class="adv_160"><a href="<?php bloginfo('url'); ?>"><img width="160" height="600" src="wp-content/themes/magazinish-parent/images/adv_160x600.png"></a></div></textarea>
        </label>
        <p>
