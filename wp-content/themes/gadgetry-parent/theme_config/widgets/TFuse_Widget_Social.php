	...
	function widget( $args, $instance )
    {
        ...
        if ($instance['position'] == 'sidebar') :
            ...
            echo '<div class="social_icons">';
                ...
                {?>
                        <a href="http://<?php echo $instance['facebook']; ?>" class="social-fb"><span><?php __('Facebook','tfuse'); ?></span></a>
                <?php }
                if ( $instance['youtube'] != '')
                {?>
                        <a href="http://<?php echo $instance['youtube']; ?>" class="social-youtube"><span><?php __('Youtube','tfuse'); ?></span></a>
                <?php }
                if ( $instance['twitter'] != '')
                {?>
                        <a href="http://<?php echo $instance['twitter']; ?>" class="social-twitter"><span><?php __('Twitter','tfuse'); ?></span></a>
                <?php }
                if ( $instance['linkedin'] != '')
                {?>
                        <a href="http://<?php echo $instance['linkedin']; ?>" class="social-linkedin"><span><?php  __('LinkedIn','tfuse'); ?></span></a>
                <?php }
            echo '</div>';
                    echo $after_widget;
            ?>
        ...
        if ($instance['position'] == 'footer') : ?>
            <div class="footer_social">
               <?php if ( $instance['facebook'] != '')
                {?>
                    <a href="http://<?php echo $instance['facebook']; ?>" class="link-fb"><span><?php __('Facebook','tfuse'); ?></span></a>
                <?php }
                if ( $instance['twitter'] != '')
                {?>
                        <a href="http://<?php echo $instance['twitter']; ?>" class="link-twitter"><span><?php __('Twitter','tfuse'); ?></span></a>
                <?php } ?>                       
	    </div>
       <?php endif;
	}
